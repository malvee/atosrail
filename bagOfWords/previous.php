        ...
        <div class ="container">
            ...
            <div class = "collapse navbar-collapse navHeaderCollapse">
                <ul class = "nav navbar-nav navbar-right">
                    ...
                    <li><a onclick="window.location.reload();">PREVIOUS</a></li>
                ...
                <div class = "col-md-12">
                    <table class ="table">
                        <tbody>
                            ...
                            <?php
                            $min_id = $_SESSION["firstTweet"];
                            $twitterQueryString = "https://api.twitter.com/1.1/search/tweets.json?q=".$twitterQueryString."&count=100&max_id=".$min_id;
